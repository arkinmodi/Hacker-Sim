...
\begin{enumerate}[start=1, label={\bf{BE\arabic*.}}]
	...
	\item The user wants to purchase items
	\begin{enumerate}[1.]
	...
	\begin{enumerate}[1.]
        ...
        \item The system shall decrease the pet’s happiness level overtime
        \item The system shall increase the pet’s hunger level overtime
        \item The system shall notify the user once any of SE’s pets wants to eat
        \item The system shall notify the user once any of SE’s pets wants to 
        play with SE(pet’s happiness level is low)
        \item The system shall notify the user once any of SE’s pets dies
    ...
    \item Accessing inventory and using items
	\begin{enumerate}[1.]
    ...
    \item Interact with objects in the room
	\begin{enumerate}[1.]
